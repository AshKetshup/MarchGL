...
namespace cparse {
	...
	class packToken {
		...
		packToken(int i): base(new Token<int64_t>(i, INTEIRO)) { }
		packToken(int64_t l): base(new Token<int64_t>(l, INTEIRO)) { }
		packToken(bool b): base(new Token<uint8_t>(b, BOOLEANO)) { }
		packToken(size_t s): base(new Token<int64_t>(s, INTEIRO)) { }
