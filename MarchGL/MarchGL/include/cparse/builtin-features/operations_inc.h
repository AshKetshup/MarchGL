...
namespace builtin_operations {
	...
	// Assignment operator "="
	inline packToken Assign(const packToken& left, const packToken& right, evaluationData* data) {
	...
	inline packToken Comma(const packToken& left, const packToken& right, evaluationData* data) {
		if (left->type == TUPLE) {
	...
	inline packToken Colon(const packToken& left, const packToken& right, evaluationData* data) {
		if (left->type == STUPLE) {
	...
	inline packToken Equal(const packToken& left, const packToken& right, evaluationData* data) {
	...
	inline packToken Different(const packToken& left, const packToken& right, evaluationData* data) {
		if (left->type == VAR || right->type == VAR) {
			throw undefined_operation(data->op, left, right);
		}
	...
	inline packToken MapIndex(const packToken& p_left, const packToken& p_right, evaluationData* data) {
	...
	inline packToken TypeSpecificFunction(const packToken& p_left, const packToken& p_right, evaluationData* data) {
	...
	inline packToken UnaryNumeralOperation(const packToken& left, const packToken& right, evaluationData* data) {
		const std::string& op = data->op;
	...
	inline packToken UnaryNotOperation(const packToken& left, const packToken& right, evaluationData* data) {
		return !right.asBool();
	}

	inline packToken NumeralOperation(const packToken& left, const packToken& right, evaluationData* data) {
	...
	inline packToken FormatOperation(const packToken& p_left, const packToken& p_right, evaluationData* data) {
	...
	inline packToken StringOnStringOperation(const packToken& p_left, const packToken& p_right, evaluationData* data) {
	...
	inline packToken StringOnNumberOperation(const packToken& p_left, const packToken& p_right, evaluationData* data) {
		const std::string& left = p_left.asString();
		const std::string& op = data->op;
	...
	inline packToken NumberOnStringOperation(const packToken& p_left, const packToken& p_right, evaluationData* data) {
	...
	inline packToken ListOnNumberOperation(const packToken& p_left, const packToken& p_right, evaluationData* data) {
	...
	inline packToken ListOnListOperation(const packToken& p_left, const packToken& p_right, evaluationData* data) {
		TokenList& left = p_left.asList();
	...
	struct Startup {
		Startup() {
			...
			opMap.add({ UNARY, "!", BOOLEANO }, &UnaryNotOperation);
